...
import { MdEmail, MdFacebook, MdPhone, MdWbTwighlight } from "react-icons/md";
import Image from "next/image";
import Link from "next/link";
Link;
export default function Footer() {
  return (
    <footer className="bg-[#1d293e] text-white">
        ...
        <div className="top_footer py-10 w-[100%] flex justify-between flex-wrap gap-6 md:gap-8">
          ...
          <div className="social flex flex-col gap-3">
            ...
            <Link
              ...
              className="fb flex gap-2 items-center"
            >
              <MdFacebook /> <span>Twitter</span>
            </Link>
            <Link
              href={"https://facebook.com"}
              className="fb flex gap-1 items-center"
            >
              <MdWbTwighlight /> <span>Instagram</span>
            </Link>
          </div>
        </div>
      </div>
      <div className="bottom_footer w-[100%] text-center
      py-6">
